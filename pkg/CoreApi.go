...
func (l *LuaCoreApiModule) Api_SendText(L *lua.LState) int {
	...
	if text != "" {
		...
		l.Client.SendMessage(ChatID, 0, false, true, nil, inputMsgTxt)
	}
	return 0
}
func (l *LuaCoreApiModule) Api_SendPhoto(L *lua.LState) int {
	...
	if path != "" {
		...
		l.Client.SendMessage(ChatID, 0, false, false, nil, inputMsg)
	}
	return 0
}
func (l *LuaCoreApiModule) Api_AddProxy(L *lua.LState) int {
	...
	if link != "" {
		...
		if err == nil {
			...
			_, err := l.Client.AddProxy(val.Get("server"), int32(port), isUser, tdlib.NewProxyTypeMtproto(val.Get("secret")))
...
func (l *LuaCoreApiModule) Api_EnableProxy(L *lua.LState) int {
	ID := L.CheckInt64(1)
	l.Client.EnableProxy(int32(ID))
	return 0
}
func (l *LuaCoreApiModule) Api_RemoveProxy(L *lua.LState) int {
	ID := L.CheckInt64(1)

	l.Client.RemoveProxy(int32(ID))
	return 0
}
func (l *LuaCoreApiModule) Api_DeleteMessages(L *lua.LState) int {
	...
	l.Client.DeleteMessages(ChatID, []int64{MessageID}, revoke)
	return 0
}
